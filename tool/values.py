...
class MyGlobals(object):
    ...
    adversary_account = Web3.toChecksumAddress('5a1cd1d07d9f59898c434ffc90a74ecd937feb12')[2:]
    sendingether_account = Web3.toChecksumAddress('564625b3ae8d0602a8fc0fe22c884b091098417f')[2:]
    send_initial_wei = 44
    web3 = None
